...
# Beta version
#KEYWORDS="~amd64"
IUSE="alsa dbus debug doc dtrace +gui java lvm nls pam pch pulseaudio +opengl python +sdk +sdl +udev vboxwebsrv vde +vmmraw vnc X"
...
COMMON_DEPEND="
	...
	pam? ( sys-libs/pam )
	python? ( ${PYTHON_DEPS} )
	sdl? ( media-libs/libsdl2[X?,video] )
