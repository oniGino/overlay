...
SLOT="6"
KEYWORDS="~amd64"
IUSE="activities docs semantic-desktop telemetry X"
...
DEPEND="
	...
	docs? ( >=kde-frameworks/kdoctools-${KFMIN}:6 )
	semantic-desktop? (
...
src_configure() {
	local mycmakeargs=(
		...
		$(cmake_use_find_package docs KF6DocTools)
