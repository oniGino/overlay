...
IUSE="activities ios exif kde +man mtp nfs +libproxy openexr phonon samba +sftp taglib X"
...
RDEPEND="${DEPEND}
	...
	kde? ( >=kde-frameworks/kded-${KFMIN}:6 )
"
...
src_configure() {
	local mycmakeargs=(
		...
		-DBUILD_KCMS=$(usex kde)
		-DWITH_LIBPROXY=$(usex libproxy)
		-DWITHOUT_X11=$(usex !X)
		$(cmake_use_find_package exif KExiv2Qt6)
