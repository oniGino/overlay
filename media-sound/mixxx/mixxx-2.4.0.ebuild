...
LICENSE="GPL-2"
SLOT="0"
IUSE="aac +ffmpeg hid keyfinder lv2 modplug mp3 mp4 opus qt6 qtkeychain +rubberband shout test wavpack"
RESTRICT="!qt6? ( qt6 )" #Upstream supports qt6 but reports it as unstable
...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-2.4.0-effectmanifest.patch #https://github.com/mixxxdj/mixxx/pull/12989
)
