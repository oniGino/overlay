...
SRC_URI="
	https://github.com/grafana/loki/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
"
EGO_SUM=(
	...
	"cloud.google.com/go/kms v1.20.2/go.mod"
	...
	"github.com/DataDog/sketches-go v1.4.6/go.mod"
	...
	"github.com/IBM/go-sdk-core/v5 v5.18.5/go.mod"
	"github.com/IBM/ibm-cos-sdk-go v1.12.1"
	"github.com/IBM/ibm-cos-sdk-go v1.12.1/go.mod"
	"github.com/IBM/sarama v1.45.0"
	"github.com/IBM/sarama v1.45.0/go.mod"
	...
	"github.com/axiomhq/hyperloglog v0.2.3/go.mod"
	"github.com/baidubce/bce-sdk-go v0.9.215"
	"github.com/baidubce/bce-sdk-go v0.9.215/go.mod"
	...
	"github.com/containerd/containerd v1.7.25/go.mod"
	...
	"github.com/digitalocean/godo v1.122.0/go.mod"
	...
	"github.com/fsouza/fake-gcs-server v1.52.1/go.mod"
	...
	"github.com/go-playground/validator/v10 v10.19.0/go.mod"
	...
	"github.com/gophercloud/gophercloud v1.14.0/go.mod"
	...
	"github.com/grafana/dskit v0.0.0-20241007172036-53283a0f6b41/go.mod"
	...
	"github.com/grafana/gomemcache v0.0.0-20240229205252-cd6a66d6fb56/go.mod"
	...
	"github.com/grpc-ecosystem/go-grpc-middleware/v2 v2.2.0/go.mod"
	...
	"github.com/hashicorp/consul/api v1.31.0/go.mod"
	...
	"github.com/heroku/x v0.4.1/go.mod"
	...
	"github.com/influxdata/telegraf v1.33.1/go.mod"
	...
	"github.com/linode/linodego v1.40.0/go.mod"
	...
	"github.com/parquet-go/parquet-go v0.24.0/go.mod"
	...
	"github.com/prometheus/alertmanager v0.28.0/go.mod"
	...
	"github.com/prometheus/prometheus v0.55.0/go.mod"
	...
	"github.com/thanos-io/objstore v0.0.0-20250115091151-a54d0f04b42a/go.mod"
	...
	"github.com/twmb/franz-go/plugin/kprom v1.1.0/go.mod"
	...
	"go.einride.tech/aip v0.68.0/go.mod"
	...
	"go.opentelemetry.io/collector/pdata v1.24.0/go.mod"
	"go.opentelemetry.io/collector/semconv v0.108.1"
	"go.opentelemetry.io/collector/semconv v0.108.1/go.mod"
	...
	"go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracehttp v1.29.0/go.mod"
	...
	"google.golang.org/genproto v0.0.0-20241216192217-9240e9c98484/go.mod"
