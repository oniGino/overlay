...
EGO_SUM=(
	...
	"cloud.google.com/go/bigtable v1.40.1/go.mod"
	...
	"cloud.google.com/go/pubsub v1.49.0/go.mod"
	...
	"github.com/IBM/go-sdk-core/v5 v5.21.0/go.mod"
	"github.com/IBM/ibm-cos-sdk-go v1.12.3"
	"github.com/IBM/ibm-cos-sdk-go v1.12.3/go.mod"
	"github.com/IBM/sarama v1.46.1"
	"github.com/IBM/sarama v1.46.1/go.mod"
	...
	"github.com/Workiva/go-datastructures v1.1.6/go.mod"
	...
	"github.com/aws/aws-sdk-go-v2/config v1.30.0/go.mod"
	...
	"github.com/aws/aws-sdk-go-v2/service/dynamodb v1.51.0/go.mod"
	...
	"github.com/aws/aws-sdk-go-v2/service/internal/endpoint-discovery v1.11.9/go.mod"
	...
	"github.com/baidubce/bce-sdk-go v0.9.245/go.mod"
	...
	"github.com/bits-and-blooms/bitset v1.10.0/go.mod"
	"github.com/bits-and-blooms/bitset v1.22.0"
	"github.com/bits-and-blooms/bitset v1.22.0/go.mod"
	"github.com/bits-and-blooms/bloom/v3 v3.7.0"
	"github.com/bits-and-blooms/bloom/v3 v3.7.0/go.mod"
	...
	"github.com/coder/quartz v0.2.1/go.mod"
	"github.com/containerd/containerd/v2 v2.0.7"
	"github.com/containerd/containerd/v2 v2.0.7/go.mod"
	...
	"github.com/digitalocean/godo v1.157.0/go.mod"
	...
	"github.com/gophercloud/gophercloud/v2 v2.7.0/go.mod"
	...
	"github.com/grafana/dskit v0.0.0-20250917065751-798f5a8fa154/go.mod"
	...
	"github.com/grafana/gomemcache v0.0.0-20250828162811-a96f6acee2fe/go.mod"
	...
	"github.com/hashicorp/go-msgpack/v2 v2.1.2/go.mod"
	...
	"github.com/heroku/x v0.5.2/go.mod"
	"github.com/hetznercloud/hcloud-go/v2 v2.21.1"
	"github.com/hetznercloud/hcloud-go/v2 v2.21.1/go.mod"
	...
	"github.com/ionos-cloud/sdk-go/v6 v6.3.4/go.mod"
	"github.com/jaegertracing/jaeger-idl v0.5.0"
	"github.com/jaegertracing/jaeger-idl v0.5.0/go.mod"
	...
	"github.com/linode/linodego v1.52.2/go.mod"
	...
	"github.com/open-telemetry/opentelemetry-collector-contrib/internal/exp/metrics v0.129.0/go.mod"
	"github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatatest v0.129.0"
	"github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatatest v0.129.0/go.mod"
	"github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatautil v0.129.0"
	"github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatautil v0.129.0/go.mod"
	"github.com/open-telemetry/opentelemetry-collector-contrib/processor/deltatocumulativeprocessor v0.129.0"
	"github.com/open-telemetry/opentelemetry-collector-contrib/processor/deltatocumulativeprocessor v0.129.0/go.mod"
	"github.com/opencontainers/go-digest v1.0.0"
	"github.com/opencontainers/go-digest v1.0.0/go.mod"
	"github.com/opencontainers/image-spec v1.1.0"
	"github.com/opencontainers/image-spec v1.1.0/go.mod"
	"github.com/opentracing-contrib/go-grpc v0.1.2"
	"github.com/opentracing-contrib/go-grpc v0.1.2/go.mod"
	...
	"github.com/parquet-go/parquet-go v0.25.1/go.mod"
	...
	"github.com/pressly/goose/v3 v3.26.0/go.mod"
	...
	"github.com/prometheus/common v0.65.1-0.20250703115700-7f8b2a0d32d3/go.mod"
	...
	"github.com/prometheus/otlptranslator v0.0.2/go.mod"
	...
	"github.com/prometheus/prometheus v0.305.1-0.20250806170547-208187eaa19b/go.mod"
	...
	"github.com/scaleway/scaleway-sdk-go v1.0.0-beta.33/go.mod"
	...
	"github.com/sercand/kuberesolver/v6 v6.0.0/go.mod"
	...
	"github.com/sony/gobreaker/v2 v2.3.0/go.mod"
	...
	"github.com/stackitcloud/stackit-sdk-go/core v0.17.2/go.mod"
	...
	"github.com/twmb/murmur3 v1.1.7/go.mod"
	...
	"go.etcd.io/etcd/api/v3 v3.6.6/go.mod"
	...
	"go.opentelemetry.io/collector/component/componentstatus v0.129.0/go.mod"
	"go.opentelemetry.io/collector/component/componenttest v0.129.0"
	"go.opentelemetry.io/collector/component/componenttest v0.129.0/go.mod"
	"go.opentelemetry.io/collector/confmap v1.35.0"
	"go.opentelemetry.io/collector/confmap v1.35.0/go.mod"
	"go.opentelemetry.io/collector/confmap/xconfmap v0.129.0"
	"go.opentelemetry.io/collector/confmap/xconfmap v0.129.0/go.mod"
	"go.opentelemetry.io/collector/consumer v1.35.0"
	"go.opentelemetry.io/collector/consumer v1.35.0/go.mod"
	"go.opentelemetry.io/collector/consumer/consumertest v0.129.0"
	"go.opentelemetry.io/collector/consumer/consumertest v0.129.0/go.mod"
	"go.opentelemetry.io/collector/consumer/xconsumer v0.129.0"
	"go.opentelemetry.io/collector/consumer/xconsumer v0.129.0/go.mod"
	"go.opentelemetry.io/collector/featuregate v1.43.0"
	"go.opentelemetry.io/collector/featuregate v1.43.0/go.mod"
	...
	"go.opentelemetry.io/collector/pdata v1.43.0/go.mod"
	...
	"go.opentelemetry.io/collector/pdata/testdata v0.129.0/go.mod"
	...
	"go.opentelemetry.io/collector/processor v1.35.0/go.mod"
	"go.opentelemetry.io/collector/processor/processortest v0.129.0"
	"go.opentelemetry.io/collector/processor/processortest v0.129.0/go.mod"
	"go.opentelemetry.io/collector/processor/xprocessor v0.129.0"
	"go.opentelemetry.io/collector/processor/xprocessor v0.129.0/go.mod"
	"go.opentelemetry.io/collector/semconv v0.128.0"
	"go.opentelemetry.io/collector/semconv v0.128.0/go.mod"
	"go.opentelemetry.io/contrib/bridges/otelzap v0.11.0"
	"go.opentelemetry.io/contrib/bridges/otelzap v0.11.0/go.mod"
	"go.opentelemetry.io/contrib/bridges/prometheus v0.61.0"
	"go.opentelemetry.io/contrib/bridges/prometheus v0.61.0/go.mod"
	...
	"go.opentelemetry.io/contrib/exporters/autoexport v0.61.0/go.mod"
	...
	"go.opentelemetry.io/contrib/instrumentation/net/http/httptrace/otelhttptrace v0.63.0/go.mod"
	...
	"go.opentelemetry.io/contrib/propagators/jaeger v1.35.0/go.mod"
	"go.opentelemetry.io/contrib/samplers/jaegerremote v0.30.0"
	"go.opentelemetry.io/contrib/samplers/jaegerremote v0.30.0/go.mod"
	...
	"go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploggrpc v0.12.2/go.mod"
	"go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploghttp v0.12.2"
	"go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploghttp v0.12.2/go.mod"
	"go.opentelemetry.io/otel/exporters/otlp/otlpmetric/otlpmetricgrpc v1.36.0"
	"go.opentelemetry.io/otel/exporters/otlp/otlpmetric/otlpmetricgrpc v1.36.0/go.mod"
	"go.opentelemetry.io/otel/exporters/otlp/otlpmetric/otlpmetrichttp v1.36.0"
	"go.opentelemetry.io/otel/exporters/otlp/otlpmetric/otlpmetrichttp v1.36.0/go.mod"
	...
	"go.opentelemetry.io/otel/exporters/prometheus v0.58.0/go.mod"
	"go.opentelemetry.io/otel/exporters/stdout/stdoutlog v0.12.2"
	"go.opentelemetry.io/otel/exporters/stdout/stdoutlog v0.12.2/go.mod"
	...
	"go.opentelemetry.io/otel/log v0.12.2/go.mod"
	"go.opentelemetry.io/otel/log/logtest v0.0.0-20250616193322-2cce18995527"
	"go.opentelemetry.io/otel/log/logtest v0.0.0-20250616193322-2cce18995527/go.mod"
	...
	"go.opentelemetry.io/otel/sdk/log v0.12.2/go.mod"
	"go.opentelemetry.io/otel/sdk/log/logtest v0.0.0-20250521073539-a85ae98dcedc"
	"go.opentelemetry.io/otel/sdk/log/logtest v0.0.0-20250521073539-a85ae98dcedc/go.mod"
	...
	"go.opentelemetry.io/proto/slim/otlp v1.8.0/go.mod"
	"go.opentelemetry.io/proto/slim/otlp/collector/profiles/v1development v0.1.0"
	"go.opentelemetry.io/proto/slim/otlp/collector/profiles/v1development v0.1.0/go.mod"
	"go.opentelemetry.io/proto/slim/otlp/profiles/v1development v0.1.0"
	"go.opentelemetry.io/proto/slim/otlp/profiles/v1development v0.1.0/go.mod"
	...
	"google.golang.org/genproto/googleapis/rpc v0.0.0-20251002232023-7c0ddcbb5797/go.mod"
