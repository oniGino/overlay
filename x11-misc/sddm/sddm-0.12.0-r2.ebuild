...
SLOT="0"
IUSE="consolekit +pam systemd upower"
...
RDEPEND="dev-qt/qtcore:5
	...
	!systemd? ( upower? ( || ( sys-power/upower sys-power/upower-pm-utils ) ) )"
...
src_prepare() {
	...
	epatch "${FILESDIR}/${P}-respect-user-flags.patch" "${FILESDIR}/${P}-CVE-2015-0856.patch" "${FILESDIR}/${P}-pmutils.patch"
