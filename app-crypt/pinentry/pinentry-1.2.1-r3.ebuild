...
IUSE="caps efl emacs kde gnome keyring ncurses qt5 X"
...
src_configure() {
	...
	local myeconfargs=(
		...
		$(use_enable gnome pinentry-gnome3)
		$(use_enable ncurses fallback-curses)
		$(use_enable ncurses pinentry-curses)
		$(use_enable qt5 pinentry-qt)
		$(use_enable kde kf5-wayland)
