...
SLOT="6"
KEYWORDS=""
IUSE="appstream +calendar +fontconfig geolocation gps kde +policykit
...
"
PDEPEND="kde? ( >=kde-plasma/kde-cli-tools-${PVCUT}:* )"
...
src_configure() {
	local mycmakeargs=(
		-DWITH_X11=$(usex X) # TODO: broken upstream, fix it if you can
