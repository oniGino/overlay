...
IUSE="appstream +fontconfig ibus +libinput evdev scim +semantic-desktop synaptics"
...
RDEPEND="${COMMON_DEPEND}
	...
	sys-apps/util-linux
	x11-apps/setxkbmap
	!<kde-plasma/kdeplasma-addons-5.15.81
"
...
src_configure() {
	local mycmakeargs=(
		...
		$(cmake-utils_use_find_package libinput XorgLibinput)
		$(cmake-utils_use_find_package scim SCIM)
		$(cmake-utils_use_find_package semantic-desktop KF5Baloo)
		$(cmake-utils_use_find_package synaptics Synaptics)
	)
