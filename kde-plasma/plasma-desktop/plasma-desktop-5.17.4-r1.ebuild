...
IUSE="+fontconfig ibus +libinput scim +semantic-desktop evdev synaptics"
...
src_configure() {
	local mycmakeargs=(
		...
		$(cmake_use_find_package evdev Evdev)
		$(cmake_use_find_package libinput XorgLibinput)
		$(cmake_use_find_package scim SCIM)
		$(cmake_use_find_package semantic-desktop KF5Baloo)
		$(cmake_use_find_package synaptics Synaptics)
	)
