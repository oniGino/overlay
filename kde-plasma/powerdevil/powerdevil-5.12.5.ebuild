...
IUSE="consolekit +bluetooth +wifi"
...
DEPEND="
	...
	wifi? ( $(add_frameworks_dep networkmanager-qt) )
"
RDEPEND="${DEPEND}
...
src_configure() {
	local mycmakeargs=(
		-DWITH_DDCUTIL=OFF
		$(cmake-utils_use_find_package bluetooth KF5BluezQt)
		$(cmake-utils_use_find_package wifi KF5NetworkManagerQt)
	)
