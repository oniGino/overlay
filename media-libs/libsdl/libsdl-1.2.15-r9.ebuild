...
IUSE="oss alsa nas X dga xv xinerama fbcon tslib aalib audiofile opengl libcaca +sound +video +joystick custom-cflags pulseaudio static-libs"
...
RDEPEND="
	...
	sound? ( audiofile? ( >=media-libs/audiofile-0.3.5[${MULTILIB_USEDEP}] ) )
