...
inherit go-module go-env xdg-utils

RESTRICT="mirror"

LICENSE="MIT"

SRC_URI="https://github.com/AvengeMedia/DankMaterialShell/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz"

S="${WORKDIR}/DankMaterialShell-${PV}"
...
src_install() {
	...
	sed -i -e "s|^SYSTEMD_USER_DIR.*|SYSTEMD_USER_DIR=${D}/usr/lib/systemd/user|" Makefile || die
	sed -i -e "s|^GOFLAGS.*|GOFLAGS ?= \"${GOFLAGS}\"|" core/Makefile || die
	go-env_set_compile_environment
