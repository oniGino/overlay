...
LICENSE="MIT"
SLOT="0"
IUSE="backlight cava evdev experimental gps jack +libinput +logind +man mpd mpris network niri pipewire pulseaudio sndio systemd test tray +udev upower wifi"
REQUIRED_USE="
	upower? ( logind )
...
RDEPEND="
	...
	cava? ( =media-sound/cava-0.10.7:lukashonakV )
	dev-libs/date:=
	dev-libs/wayland
