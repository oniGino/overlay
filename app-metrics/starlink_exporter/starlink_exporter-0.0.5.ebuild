...
SRC_URI="https://github.com/danopstech/starlink_exporter/archive/v${PV}.tar.gz -> ${P}.tar.gz"
...
EGO_SUM=(
	...
	"google.golang.org/genproto v0.0.0-20210506142907-4a47615972c2/go.mod"
...
src_compile() {
	ego build cmd/starlink_exporter/main.go
}
