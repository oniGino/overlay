...
IUSE="agent colorhug consolekit dell doc elogind +gpg introspection +man modemmanager nvme pkcs7 redfish systemd test thunderbolt uefi"
...
RDEPEND="${PYTHON_DEPS}
	...
	modemmanager? ( >=net-misc/modemmanager-1.10.0[qmi] )
...
DEPEND="${RDEPEND}
	...
	uefi? ( x11-libs/pango[introspection] )
...
src_configure() {
	...
	local emesonargs=(
		...
		-Dplugin_modem_manager="$(usex modemmanager true false)"
