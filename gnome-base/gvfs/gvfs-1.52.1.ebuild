...
IUSE="afp archive bluray cdda elogind fuse gcr google keyring gnome-online-accounts gphoto2 +http ios man mtp nfs policykit samba scp sftp systemd test +udev udisks zeroconf"
RESTRICT="!test? ( test )"
